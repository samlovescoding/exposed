        ...
        <div class="card-body">
            ...
            <form class="form-horizontal m-t-20" method="post">
                ...
                <div class="form-group text-center m-t-40">
                    <div class="col-12">
                        <button class="btn btn-primary btn-block btn-lg waves-effect waves-light" name="login" value="login" type="submit">Send Email</button>
                    </div>
                </div>

                <div class="form-group row m-t-30 m-b-0">
                    <div class="col-sm-7">
                        <a href="<?=base_url("authentication/login/")?>" class="text-muted">Login Instead</a>
                    </div>
